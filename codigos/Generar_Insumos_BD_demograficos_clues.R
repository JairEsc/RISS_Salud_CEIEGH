...
clues_en_operacion_s=clues_en_operacion_s |> 
  dplyr::select(CLUES,archivo_origen,MUNICIPIO,LOCALIDAD,NOMBRE.DE.LA.UNIDAD,NOMBRE.DE.LA.INSTITUCION,NIVEL.ATENCION,Conteo_N1_T10:SALUD10_T60,geometry)
  dplyr::mutate(archivo_origen= stringr::str_extract(archivo_origen,"Público|Privado")) |> 
  dplyr::filter(!is.na(archivo_origen) )
